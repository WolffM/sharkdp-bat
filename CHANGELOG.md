...
## Bugfixes
- Build macOS binaries with vendored libgit2 by default, preventing runtime failures from missing `libgit2@1.7` dylibs in package manager environments, see #2 (@copilot)
